    ...
    <div className="container-carrousel">
      ...
      >
        <SwiperSlide className="slide-item">
          <img src={timeMasFuria} className="images-carrossel" alt="Time Masculino Furia" />
          <div className="sombra-overlay">
        ...
        <SwiperSlide className="slide-item">
          <img src={timeFemFuria} className="images-carrossel" alt="Time Feminino Furia" />
          <div className="sombra-overlay">
        ...
        <SwiperSlide className="slide-item">
          <img src={timeMasFuria2} className="images-carrossel" alt="Time Feminino Furia" />
          <div className="sombra-overlay">
