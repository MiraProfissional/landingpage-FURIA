	...
	return (
		<div id="container-footer">
			<div className="container-footer-conteudo">
				<div>
					<a href="#container-navbar">
						<img
							src="../images/Logos/logo-furia-footer.png"
							alt="logo-furia-footer"
						/>
					</a>
				</div>
				<div className="div-paginas-footer">
					...
					<ul>
						<li>
							<a href="#container-navbar">Home</a>
						</li>
						<li>
				...
				<div className="div-politicas-footer">
					...
					<ul>
						<li>
							<a
								href="https://furia.gg/terms-and-conditions/"
								rel="noreferrer"
								target="_blank"
							>
								Termos e Condições
						...
						<li>
							<a
								href="https://furia.gg/privacy-policy/"
								rel="noreferrer"
								target="_blank"
							>
						...
						<li>
							<a
								href="https://furia.gg/cookie-policy/"
								rel="noreferrer"
								target="_blank"
							>
								Política de Cookies
				...
				<div className="div-social-media-footer">
					...
					<ul>
						...
						<li className="item-lista-social-media-footer">
							<a
								href={
									"https://www.youtube.com/channel/UCE4elIT7DqDv545IA71feHg"
								}
								className="link-social-media-furia"
								rel="noreferrer"
								target="_blank"
			...
			<div className="copyright">
				<p>
					<a
						href="https://www.linkedin.com/in/jvitor-gmira/"
						rel="noreferrer"
						target="_blank"
					>
